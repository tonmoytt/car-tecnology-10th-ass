...
const CardDataShow = ({ PropsCarddata }) => {
    const { _id, image, name, brandnm, category, Price, rating } = PropsCarddata
    return (
        <div>
                ...
                <div className="card w-full min-h-screen my-4 p-3 bg-black shadow-xl">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions items-center mt-6 justify-end">
                            ...
                            <Link to={`/user/${_id}`}><button className="btn btn-outline btn-error">Deleted</button></Link>
